...
async def on_member_join(member):
    guild = await client.get_guild(1065617002393247808)
    general_channel = await client.fetch_channel(1065617003949338676)
    await general_channel.send(f"{member.mention} has joined the server!")
